...
INSERT INTO roles (role_name) VALUES ('user'), ('editor'), ('moderator');
...
INSERT INTO games (title, description, release_date, platform, developer, editor_id) VALUES
('Game1', 'Description for Game1', '2022-01-01', 'Platform1', 'Developer1', 3),
...
INSERT INTO reviews (game_id, user_id, comment, date, is_blocked) VALUES
(1, 1, 'Review for Game1 by User1', '2022-01-05', FALSE),
...
INSERT INTO user_game_collections (user_id, game_id, date_added) VALUES
(1, 1, '2022-01-15'),
(1, 2, '2022-02-20'),
(2, 3, '2022-03-25');

-- Заполнение таблицы notifications
INSERT INTO notifications (user_id, game_id, notification_type, is_notified) VALUES
(1, 1, 'Type1', TRUE),
(2, 2, 'Type2', FALSE),
(2, 3, 'Type3', TRUE);

-- Заполнение таблицы games_suggestions
INSERT INTO games_suggestions (title, description, user_id, status) VALUES
('Suggested Game1', 'Description for Suggested Game1', 1, 'Pending'),
